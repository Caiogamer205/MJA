function cod(){
    ...
    if(personagem == "Alex Mason"){
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://upload.wikimedia.org/wikipedia/pt/a/a3/Alex_Mason_foto.png' width = '190' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://titles.trackercdn.com/modern-warfare/db/images/ui_operator_west_price_portrait.png' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://upload.wikimedia.org/wikipedia/en/5/5e/John_%22Soap%22_MacTavish_MW3.png' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/0/04/Ghost_in_Loose_Ends_MW2CR.jpg/revision/latest?cb=20200929024444' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/a/af/Thomas_Merrick_Mugshot_CODG.jpg/revision/latest?cb=20131023000906' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://i.pinimg.com/originals/5a/1f/d7/5a1fd7dd64ce40f85e0962acbb32ca47.jpg' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/5/56/Logan_Walker_CoDG.jpg/revision/latest?cb=20180114235711' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/f/f5/LucasRiggs_Promo_CODV.png/revision/latest?cb=20210820092005' width = '210' height = '255'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/9/9c/JasonHudson_RevealTrailer_BOCW.png/revision/latest?cb=20200826203728' width = '190' height = '235'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/callofduty/images/3/37/Menendez_close_up_BOII.jpg/revision/latest?cb=20210202132506' width = '190' height = '235'>";
    }
}
