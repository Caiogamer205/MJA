function cod(){
    ...
    if(personagem == "Alex Mason"){
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://i.pinimg.com/originals/06/e9/df/06e9dfccd471239b08d732202ed64829.png' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://pbs.twimg.com/profile_images/476002862888009729/FpPu7jd7.jpeg' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://pdacdn.com/photo/unnamed_146.jpg' width = '210' height = '225'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'http://pm1.narvii.com/8107/02c424e886c8afead3ae9788816ef46922a4fd09r1-1034-1437v2_uhq.jpg' width = '210' height = '255'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://pm1.narvii.com/6687/53b3e9a866508755751b5e89eada43593a493006_hq.jpg' width = '190' height = '235'>";
    }
        ...
        document.getElementById("img").innerHTML = "<img src = 'https://static.wikia.nocookie.net/legendsofthemultiuniverse/images/3/37/Menendez_close_up_BOII.jpg/revision/latest?cb=20160117061842' width = '190' height = '235'>";
    }
}
